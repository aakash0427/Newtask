...
// if(isset($_POST["submit"])){
//   $result = $insertt->insert($_POST["productname"], $_POST["sku"], $_POST["price"], $_POST["size"],$_POST["image"],$_POST["file"]);
//   if($result == 1){
//     echo
...
<div class="container">
    <form action="" method="post" id="myTable" enctype="multipart/form-data" autocomplete="off">
        ...
        <input type="text" class="input" placeholder="Product Name" id="productname" name="productname" value="">

        <label for="sku">SKU</label>
        <input type="text" class="input" placeholder="Product-Code" id="sku" name="sku" value="">

        <div class="row">
          <div class="col-md-6">
        <label for="size">Size</label>
        <input type="number" class="input" placeholder="Enter Size" id="size" name="size" value="">
          </div>
          <div class="col-md-6">
        <label for="Price">Price</label>
        <input type="text" class="input" placeholder="Price" id="price" name="price" value="">
          </div>
        </div>
